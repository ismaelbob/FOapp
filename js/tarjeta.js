$(document).ready(() => {
    ...
    $('#chkapo3-1').click(() => {actualizarAporteEnBD($('#chkapo3-1'), aportes3)})
    $('#chkapo3-2').click(() => {actualizarAporteEnBD($('#chkapo3-2'), aportes3)})
    $('#chkapo3-3').click(() => {actualizarAporteEnBD($('#chkapo3-3'), aportes3)})
    $('#chkapo3-4').click(() => {actualizarAporteEnBD($('#chkapo3-4'), aportes3)})
    $('#chkapo3-5').click(() => {actualizarAporteEnBD($('#chkapo3-5'), aportes3)})
    $('#chkapo3-6').click(() => {actualizarAporteEnBD($('#chkapo3-6'), aportes3)})
    $('#chkapo3-7').click(() => {actualizarAporteEnBD($('#chkapo3-7'), aportes3)})
    $('#chkapo3-8').click(() => {actualizarAporteEnBD($('#chkapo3-8'), aportes3)})
    $('#chkapo3-9').click(() => {actualizarAporteEnBD($('#chkapo3-9'), aportes3)})
    $('#chkapo3-10').click(() => {actualizarAporteEnBD($('#chkapo3-10'), aportes3)})
    $('#chkapo3-11').click(() => {actualizarAporteEnBD($('#chkapo3-11'), aportes3)})
    $('#chkapo3-12').click(() => {actualizarAporteEnBD($('#chkapo3-12'), aportes3)})
